...
class CafeForm(FlaskForm):
    ...
    open_time = StringField('Opening Time e.g. 7:30AM', validators=[DataRequired()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        with open('cafe-data.csv', 'a', newline='', encoding='utf8') as csv_file:
            ...
            csv_writer.writerow([form.cafe.data, form.location.data, form.open_time.data, form.close_time.data, form.coffee_rating.data, form.wifi_rating.data, form.power.data])
    # Exercise:
